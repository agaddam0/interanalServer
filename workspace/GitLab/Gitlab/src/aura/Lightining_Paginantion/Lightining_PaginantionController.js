({
 doInit : function(component, event, helper)
    {
        var pageSize = component.get("v.pageSize");// get the defualt size of page
        
        var action = component.get("c.getAccounts");// calling apex method 
        ...
        action.setCallback(this, function(response) 
  {
    ...
    next : function(component, event, helper) 
    {
     var accountList = component.get("v.acccountList");
        ...
        start = start + counter;// alert('>>>>>'+start);
        end = end + counter;// alert('<>'+end);
