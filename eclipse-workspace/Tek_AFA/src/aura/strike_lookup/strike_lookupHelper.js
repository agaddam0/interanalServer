({
    ...
    updateValueByFocusIndex: function(component, event, helper) {
        ...
        if (focusIndex < records.length) {
            ...
            // this is when we want to fire the update handler
            this.fireChangeEvent(component, event);
    ...
    fireChangeEvent : function(component, event) {
        var fireValueChangeEvents = component.get('v.fireValueChangeEvents');
        ...
        // fired for strike
        var changeEvent = $A.get("e.c:strike_change_evt");
        ...
        // fired for fieldsetform
        var fieldSetFormChangeEvent = component.getEvent("fieldChange");
        fieldSetFormChangeEvent.setParams({
            "fieldValue" : value,
            "fieldLabel" : label
        });
        fieldSetFormChangeEvent.fire();
    }
})